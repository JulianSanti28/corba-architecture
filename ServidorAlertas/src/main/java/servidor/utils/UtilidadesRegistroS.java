...
import sop_corba.IStudentControllerHelper;

public class UtilidadesRegistroS {

    public static void registrarObjetoRemoto(String[] vectorDatosNS, ControllerStudentImpl objRemoto, String idObjetoRemoto) throws ServantNotActive, WrongPolicy, org.omg.CORBA.ORBPackage.InvalidName, AdapterInactive, InvalidName, NotFound, CannotProceed
    {
        ...
        IStudentController href = IStudentControllerHelper.narrow(obj);
